...
*See also: [Supported Elements User Guide](supported-elements-user-guide.md) for element property reference, [LangGraph Connector Guide](langgraph-connector-user-guide.md) for connector details.*
